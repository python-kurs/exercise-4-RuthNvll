...
#------------------------------------------------------------------------
# set directory
data_dir = ("C:/Users/Ruth/Desktop/Eigene_Dateien/01_Studium/PhyGeo_Msc/Profilmodule/Python/exercise-4-RuthNvll/")
...
garmisch  = pd.read_csv(data_dir + "data/produkt_klima_tag_20171010_20190412_01550.txt", parse_dates=["MESS_DATUM"], index_col="MESS_DATUM", sep=";")
zugspitze = pd.read_csv(data_dir + "data/produkt_klima_tag_20171010_20190412_05792.txt", parse_dates=["MESS_DATUM"], index_col="MESS_DATUM", sep=";")
...
def create_climate_diagram(df, 
    ...
    ax2.bar(df.index, height = df[prec_col], color = "midnightblue", width = 20, label = "Precipitation")
    ax1.plot(df[temp_col], color = "crimson", label = "Temperature")
...
create_climate_diagram(df = garmisch, 
                       temp_col = " TMK", 
                       prec_col = " RSK", 
                       title = "Climate Diagram Garmisch 2018", 
                       filename = data_dir + "result/Climate_Garmisch2018.png", 
                       temp_min = -15, temp_max= 20, prec_min= 0, prec_max= 370)

create_climate_diagram(df = zugspitze, 
                       temp_col = " TMK", 
                       prec_col = " RSK", 
                       title = "Climate Diagram Zugspitze 2018", 
                       filename = data_dir + "result/Climate_Zugspitze2018.png", 
                       temp_min = -15, temp_max = 20, prec_min = 0, prec_max = 370)
